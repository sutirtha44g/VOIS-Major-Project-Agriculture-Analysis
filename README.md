...
AICTE Student ID: STU6a6050cd2e1271784697037
...
* Filled missing environmental variables using seasonal medians to prevent seasonal distortion.
* Recalculated missing crop yields using the formula: Production_Tonnes / Farm_Area_Hectares.
